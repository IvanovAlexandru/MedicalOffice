...
export default function AdminPage({onPageChange,onActionChange}){
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" sx={{ width: '100%', left: 0, right: 0 }}>
        <Toolbar>
          ...
          onClick={() => handleActionChange('add-doctor')}>
            Add Doctors
          </Button>
          <Button sx={{ flexGrow: 1 }}
          onClick={() => handleActionChange('manage-patients')}>
            View Patients
          </Button>
          <Button sx={{flexGrow: 1 }}
          onClick={() => handleActionChange('manage-doctors')}>
            View Doctors
          </Button>
          <Button
            sx={{ flexGrow: 1 }} 
